...
<table width='100%' border='1' class='card' style='margin-bottom: 1em; border: 1px solid #333;'>
			<tr>
				...
				<td width='1920'><a href='https://github.com/lost-scripts/ls_shapes'><strong>Shapes</strong></a><br>Persistent shape palette plus helpers for better Moho&reg; vector/s management.</td>
...
<table width='100%' border='1' class='card' style='margin-bottom: 1em; border: 1px solid #333;'>
			<tr>
				...
				<td align='center' width='240'><a href='https://github.com/lost-scripts/ls_wiggle'><img src='https://img.shields.io/badge/Soon…-lightgrey.svg' alt='Download unavailable' title='Upload pending...' height='24'></a></td>
			</tr>
		</table>
