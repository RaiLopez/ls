<table id='top' width='100%' border='0'><tr><td align='left' valign='middle' width='120'><picture><source media='(prefers-color-scheme: dark)' srcset='https://raw.githubusercontent.com/RaiLopez/RaiLopez/refs/heads/main/docs/ls/assets/icon_dark.png'><source media='(prefers-color-scheme: light)' srcset='https://raw.githubusercontent.com/RaiLopez/RaiLopez/refs/heads/main/docs/ls/assets/icon_light.png'><img src='https://raw.githubusercontent.com/RaiLopez/RaiLopez/refs/heads/main/docs/ls/assets/icon.png' width='48' alt='Icon' title='LS: Essential shared resources and core modules required for the Lost Scripts&trade; project to work with MOHO&nbsp;Pro Animation Software.' class='colorize'></picture></td><td align='right' valign='middle' width='1920' nowrap><a href='https://github.com/RaiLopez/ls/releases/latest/download/ls.zip' title='Download latest version...'><img src='https://img.shields.io/github/downloads/RaiLopez/ls/total?logo=data:image/svg%2bxml;base64,&color=blue&label=Download' alt='Download'></a>  <a href='https://github.com/RaiLopez/ls/releases/latest' title='Go to release in GitHub...'><img src='https://img.shields.io/github/release/RaiLopez/ls?logo=github&color=yellow&label=Release' alt='Release'></a>  <a href='https://moho.lostmarble.com/' title='Go to Moho® homepage...'><img src='https://img.shields.io/badge/For-Moho_14_Pro-orange' alt='Moho'></a> </td></tr></table>
...
<table width='100%' border='0' style='border: 1px solid #444; border-radius: 8px; margin-bottom: 10px; padding: 10px;'>
			<tr>
				<td align='center' width='80'>
					<a href='https://github.com/lost-scripts/ls_shapes'><img src='https://raw.githubusercontent.com/RaiLopez/ls_shapes/main/docs/assets/icon.png' width='48' class='colorize' alt='Icon'></a>
				</td>
				<td valign='middle'>
					<a href='https://github.com/lost-scripts/ls_shapes' style='text-decoration:none;'><strong>Shapes</strong></a><br>
					<small>Persistent shape palette plus helpers for better Moho&reg; vector/s management.</small>
				</td>
...
<table width='100%' border='0' style='border: 1px solid #444; border-radius: 8px; margin-bottom: 10px; padding: 10px;'>
			<tr>
				<td align='center' width='80'>
					<a href='https://github.com/lost-scripts/ls_wiggle'><img src='https://raw.githubusercontent.com/RaiLopez/ls_wiggle/main/docs/assets/icon.png' width='48' class='colorize' alt='Icon'></a>
				</td>
				<td valign='middle'>
					<a href='https://github.com/lost-scripts/ls_wiggle' style='text-decoration:none;'><strong>Wiggle</strong></a><br>
					<small>Animation helpers and mouse capturing for Moho&reg; Animation Software.</small>
				</td>
				<td align='right' width='120' valign='middle'>
